...
<head>
    ...
    <!-- begin Convert Experiences code-->
        <script
          ...
          src="https://cdn-3.convertexperiments.com/js/10034551-10032757.js"
        ></script>
    ...
    <script type="text/javascript">
      ...
      (function () {
        ...
        mf.defer = true;
        mf.src =
          "//cdn.mouseflow.com/projects/c692c3e2-7201-496a-8338-554beb917458.js";
    ...
    <body>
        ...
        <header>
            <div class="header-top">
                <div class="container">
                    <ul>
                        <li><a href="#"><span><img src="/obvikids/images/icons/asset_3.png" alt="" /></span>MADE IN
                            THE USA</a></li>
                            <li><a href="#"><span><img src="/obvikids/images/icons/asset_4.png" alt="" /></span>GLUTEN
                                FREE</a></li>
                                <li><a href="#"><span><img src="/obvikids/images/icons/asset_5.png" alt="" /></span>FDA
                                    APPROVED</a></li>
                                    <li><a href="#"><span><img src="/obvikids/images/icons/asset_6.png" alt="" /></span>FREE
                                        USA SHIPPING</a></li>
                                    </ul>
                                    <h3 class="mobile-header-text">free SHIPPING on all usa orders today </h3>
                                </div>
                            </div>
                            <div class="header-bottom">
                                    ...
                                    <div class="inner">
                                        ...
                                        <ul class="nav-bar">
                                            ...
                                            <li>
                                                ...
                                                <li class="drop-down">
                                                    <a href="#"><i class="fa fa-cubes" aria-hidden="true"></i> Bundle & Save <i
                                                        class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="https://myobvi.com/apps/bundles/bundle/24772" class="sub-link">
                                                                    ...
                                                                    <div class="sub-text-wrap">
                                                                        ...
                                                                        <span class="sub-desp">Save 15% & Includes Free Shaker</span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="https://myobvi.com/products/beauty-burn-bundle" class="sub-link">
                                                                    ...
                                                                    <div class="sub-text-wrap">
                                                                        ...
                                                                        <span class="sub-desp">Best of Both Worlds</span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="https://myobvi.com/products/mommy-me-protein-bundle" class="sub-link">
                                                                    ...
                                                                    <div class="sub-text-wrap">
                                                                        ...
                                                                        <span class="sub-desp">Collagen For You. Protein For Them.</span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="https://myobvi.com/products/collagen-lovers-protein-bundle" class="sub-link">
                                                                    ...
                                                                    <div class="sub-text-wrap">
                                                                        ...
                                                                        <span class="sub-desp">Select 2 Favorites</span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li class="drop-down">
                                                        <a href="#"><i class="fa fa-truck" aria-hidden="true"></i> Distribution <i
                                                            class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                            <ul class="sub-menu">
                                                                <li>
                                        ...
                                        <section class="banner_section">
                                            <div class="container">
                                                <div class="banner_content">
                                                    <h2 class="banner-heading">
                                                        YOUR PICKY <br>EATERS DESERVE <br>TO
                                                        <span>GROW TOO!</span>
                                                    </h2>
                                                    <div class="mobile-banner-image">
                                                        <img src="/obvikids/images/mobile_images/main-image-on-mobile.png" alt="" />
                                                    </div>
                                                    <p>Finally, a protein shake that will win over even the pickiest little eaters while giving them a
                                            ...
                                            <section class="feature-in-block">
                                                <div class="feature-mobile-menu">
                                                    <img src="/obvikids/images/mobile_images/Untitled-design-1024x252.png" alt="" />
                                                </div>
                                                <div class="container">
                                                    <h3>Featured In</h3>
                                                    <div class="feature-logos">
                                                        <ul>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-1.png" alt="" /></a></li>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-2.png" alt="" /></a></li>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-3.png" alt="" /></a></li>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-4.png" alt="" /></a></li>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-5.png" alt="" /></a></li>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-6.png" alt="" /></a></li>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-7.png" alt="" /></a></li>
                                                            <li><a href="#"><img src="/obvikids/images/feature-logos/logo-8.png" alt="" /></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="featured-large-image">
                                                    <img src="/obvikids/images/section_banners/asset_57.png" alt="" />
                                                </div>
                                            </section>

                                            <!---- Feature In End -->

                                            <!---- We Know Section Start-->

                                            <section class="we-know-section">
                                                <div class="container">
                                                    <div class="we-know-content">
                                                        <div class="content-image">
                                                            <img src="/obvikids/images/other_images/asset_12.png" alt="" />
                                                        </div>
                                                        <div class="we-know-text">
                                                            <h3>WE KNOW IT'S A PROBLEM</h3>
                                                            <span>GOT A PICKY EATER AT HOME?</span>
                                                            <p>If you’re a parent of a young child (aged 4-12), making sure your child is eating enough, gaining
                                                                weight appropriately, and receiving the right nutrition is very important to you. That’s why it
                                                                isn’t easy to see your little ones reject most of the meals you put in front of them or would
                                                                rather eat one thing which of course isn’t enough. You go out of your way to make sure you
                                                                prepare the best meals, making lunchtime fun and exciting, but your efforts are usually met with
                                                                food fights and bribery. Well, you should know what you are not alone. Most parents confess to
                                                                having picky eaters who are not getting enough protein to fuel all of their activities and
                                                                growth.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <!---- Coming up with a new solution Section Start-->

                                                <section class="coming-up-solution">
                                                    <div class="container">
                                                        <div class="solution_content">
                                                            <div class="solution-text">
                                                                <h3>COMING UP WITH A DELICIOUS SOLUTION</h3>
                                                                <span>BEING PICKY DOESN'T MEAN</span>
                                                                <span>THEY SHOULD MISS OUT</span>
                                                                <p>Just because your child is a picky eater doesn’t mean they have to consume less protein than
                                                                    other children, their nutritional needs have to be met. That’s why we came up with Obvi’s Kids’
                                                                    complete protein, which contains all the nutrients your child needs to grow and develop, while
                                                                    also packing a great taste that they will love. Compare to sugar-ridden meal replacement shakes,
                                                                    our shakes are fortified with 10g of protein plus 18 vitamins & minerals. We have won over some
                                                    ...
                                                    <!---- Coming up with a new solution Section End -->
                                                    ...
                                                    <section class="why-choose-section">
                                                        <div class="container">
                                                            <div class="top-heading">
                                                                <h3>SO, WHY CHOOSE OBVI?</h3>
                                                                <span>HERE'S WHY OUR PROTEIN SHAKE IS PICKY EATER APPROVED</span>
                                                            </div>
                                                            <div class="why-choose-content">
                                                                <div class="left-content">
                                                                    <div class="inner-content">
                                                                        <img src="/obvikids/images/icons/asset_14.png" alt="" />
                                                                        <h4>PERFECT MEAL REPLACEMENT</h4>
                                                                        <p>We know you're busy so we made it easy. Our shakes are perfect for breakfast, lunch, or a
                                                                            tasty afternoon snack</p>
                                                                        </div>
                                                                        <div class="inner-content">
                                                                            <img src="/obvikids/images/icons/icons8-double-tick-100.png" alt="" />
                                                                            <h4>PROVEN RESULTS</h4>
                                                                            <p>Our formula contains protein and vitamins and minerals that are proven to help your child
                                                                                grow in as little as 8 weeks.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="middle-content">
                                                                            <img src="/obvikids/images/other_images/asset_16.png" alt="" />
                                                                        </div>
                                                                        <div class="right-content">
                                                                            <div class="inner-content">
                                                                                <img src="/obvikids/images/icons/asset_17.png" alt="" />
                                                                                <h4>PERFECT FOR ACTIVE KIDS</h4>
                                                                                <p>We give parents peace of mind knowing that their little athletes are getting all of the
                                                                                    nutrients they need to replenish their bodies.</p>
                                                                                </div>
                                                                                <div class="inner-content">
                                                                                    <img src="/obvikids/images/icons/asset_18.png" alt="" />
                                                                                    <h4>DELICIOUS FLAVORS & RECIPES</h4>
                                                                                    <p>Our shakes contain mouthwatering flavors your kids will love while still packing the nutrient
                                                                                        they need.</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <section class="customers-thorughts">
                                                                        <div class="melting_wave_border">
                                                                    ...
                                                                    <div class="container">
                                                                        <div class="top-heading">
                                                                            <h3>WE ASKED OUR CUSTOMERS WHAT THEY THOUGHT</h3>
                                                                            <span>REAL PEOPLE WITH REAL RESULTS</span>
                                                                        </div>
                                                                        <div class="customers-thorughts-box">
                                                                            <div class="box-content">
                                                                                <img src="/obvikids/images/reviews/asset_19.jpeg" alt="" />
                                                                                <span class="quote_icon"></span>
                                                                                <p>This is seriously some good stuff right here. I bought this for my girls to make sure they're
                                                                                    getting their protein. Yes, I tried it and Yes it tastes just like fruit loop cereal milk!</p>
                                                                                    <span>Shelley Slenbaker</span>
                                                                                </div>
                                                                                <div class="box-content">
                                                                                    <img src="/obvikids/images/reviews/asset_20.jpeg" alt="" />
                                                                                    <span class="quote_icon"></span>
                                                                                    <p>Kai really doesn't eat much meat, either. Only in the form of chicken nugget from McDdonalds.
                                                                                        Their protein is so limited due to extreme pickiness. So I'm always searching for kid friendly
                                                                                        and tasty options. @myobvi is the win!</p>
                                                                                        <span>@thatawkwardfamily</span>
                                                                                    </div>
                                                                                    <div class="box-content">
                                                                                        <img src="/obvikids/images/reviews/asset_21.jpeg" alt="" />
                                                                                        <span class="quote_icon"></span>
                                                                                        <p>My Daughter loves that she has a shake just like me. She says it's so yummy</p>
                                                                                        <span>Christina Murphy</span>
                                                                                    </div>
                                                                                    <div class="box-content">
                                                                                        <img src="/obvikids/images/reviews/asset_22.jpeg" alt="" />
                                                                                        <span class="quote_icon"></span>
                                                                                        <p>Today we used it to make #ketofriendly pancakes for breakfast! (okay, the fruit loops are not
                                                                                            keto friendly, but the kids love them!) I love finding ways to sneak healthy ingredients into
                                                                                            their food...They loved them, and mama even enjoyed a pancake or two, minus the fruit loops of
                                                                                            course</p>
                                                                                            <span>@breannagoesketo</span>
                                                                                        </div>
                                                                                        <div class="box-content">
                                                                                            <img src="/obvikids/images/reviews/asset_23.jpeg" alt="" />
                                                                                            <span class="quote_icon"></span>
                                                                                            <p>Just got ours in today. We tried the chocolate today (yes momma tasted too YUM). My son
                                                                                                absolutely loved it! Hopefully, he likes the fruit one just as much.</p>
                                                                                                <span>Sieara Scott Del Col</span>
                                                                                            </div>
                                                                                            <div class="box-content">
                                                                                                <img src="/obvikids/images/reviews/asset_24.jpeg" alt="" />
                                                                                                <span class="quote_icon"></span>
                                                                                                <p>I bought this for my grand daughters. One is the pickiest eater!!! And they love it!!</p>
                                                                                                <span>Jared Glenda Armstrong</span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="section-footer">
                                                                                            <a href="#pkg_sec" class="primery_btn">Try It Out</a>
                                                                                ...
                                                                                <!---- Micro Nutrient Section Start-->

                                                                                <section class="micro-nutrient-section">
                                                                                    <div class="container">
                                                                                        <div class="top-heading">
                                                                                            <h3>MICRO-NUTRIENTS</h3>
                                                                                            <p>THESE MICRO-NUTRIENTS ARE ESSENTIAL FOR YOUR CHILD'S GROWTH,<br />
                                                                                                OVERALL HEALTH AND WELL BEING. THAT'S WHY WE INCLUDED THEM IN EVERY SCOPE</p>
                                                                                            </div>
                                                                                            <div class="inner-content">
                                                                                                <ul>
                                                                                                    <li>
                                                                                                        <div class="integ-image">
                                                                                                            <img src="/obvikids/images/fruits/vitamin-c.png" alt="orange image" />
                                                                                                        </div>
                                                                                                        <p>Vitamin C</p>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <div class="integ-image">
                                                                                                            <img src="/obvikids/images/fruits/vitamin-a.png" alt="vitamin image" />
                                                                                                        </div>
                                                                                                        <p>Vitamin A</p>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <div class="integ-image">
                                                                                                            <img src="/obvikids/images/fruits/vitamin-d.png" alt="vitamin image" />
                                                                                                        </div>
                                                                                                        <p>Vitamin D</p>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <div class="integ-image">
                                                                                                            <img src="/obvikids/images/fruits/boitin.png" alt="botin imgae" />
                                                                                                        </div>
                                                                                                        <p>Biotin</p>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <div class="integ-image">
                                                                                                            <img src="/obvikids/images/fruits/calcium.png" alt="calcium image" />
                                                                                                        </div>
                                                                                                        <p>Calcium</p>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <div class="integ-image">
                                                                                                            <img src="/obvikids/images/fruits/iron.png" alt="iron image" />
                                                                                                        </div>
                                                                                                        <p>Iron</p>
                                                                                                    </li>
                                                                                                </ul>
                                                                                            </div>
                                                                                            <div class="nutrients-importance">
                                                                                                <!-- Grid row -->
                                                                                                <span class="note">CLICK TO SEE WHY THESE MIRCO NUTRIENTS ARE IMPORTANT</span>
                                                                                                <div class="row accordion-gradient-bcg d-flex justify-content-center">
                                                                                                    ...
                                                                                                    <div class="col-md-12">
                                                                                                        ...
                                                                                                        <div class="card">
                                                                                                            ...
                                                                                                            <div class="card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading1">
                                                                                                                ...
                                                                                                                <h5 class="mb-0 white-text text-uppercase font-thin">
                                                                                                                    + VITAMIN D <i class="fas fa-angle-down rotate-icon"></i>
                                                                                                                </h5>
                                                                                                            </a>
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div class="card-body mb-1">
                                                                                                            <p class="nutrition_detail">Vitamin D Promotes Calcium Absorption And Bone
                                                                                                                Mineralization. Without Proper Vitamin D Consumption Growth Can Be Stunted.
                                                                                                            </p>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="card">
                                                                                                    ...
                                                                                                    <div class="card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading2">
                                                                                                        ...
                                                                                                        <h5 class="mb-0 white-text text-uppercase font-thin">
                                                                                                            + IRON<i class="fas fa-angle-down rotate-icon"></i>
                                                                                                        </h5>
                                                                                                    </a>
                                                                                                </div>
                                                                                                ...
                                                                                                data-parent="#accordionEx7">
                                                                                                <div class="card-body mb-1">
                                                                                                    <p class="nutrition_detail">Insufficient Iron Intake Can Lead To Appetite And
                                                                                                        Immunity Problems Which Can Eventually Impair Growth.</p>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <!-- Accordion card -->
                                                                                            ...
                                                                                            <div class="card">
                                                                                                ...
                                                                                                <div class="card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading3">
                                                                                                    ...
                                                                                                    <h5 class="mb-0 white-text text-uppercase font-thin">
                                                                                                        + VITAMIN A<i class="fas fa-angle-down rotate-icon"></i>
                                                                                                    </h5>
                                                                                                </a>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="card-body mb-1 rgba-grey-light white-text">
                                                                                                <p class="nutrition_detail">Vitamin A Supports A Healthy Immune System And
                                                                                                    Reduces Infection And Digestive Issues.</p>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <!-- Accordion card -->
                                                                                        ...
                                                                                        <div class="card">
                                                                                            ...
                                                                                            <div class="card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading4">
                                                                                                ...
                                                                                                <h5 class="mb-0 white-text text-uppercase font-thin">
                                                                                                    + BIOTIN<i class="fas fa-angle-down rotate-icon"></i>
                                                                                                </h5>
                                                                                            </a>
                                                                                        </div>
                                                                                        ...
                                                                                        data-parent="#accordionEx7">
                                                                                        <div class="card-body mb-1">
                                                                                            <p class="nutrition_detail">Biotin Will Do Wonders For Your Child's Hair, Skin &
                                                                                                Nails. Biotin Deficiency Can Leave Your Child More Susceptible To Infectious
                                                                                    ...
                                                                                    <div class="card">
                                                                                        ...
                                                                                        <div class="card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading5">
                                                                                            ...
                                                                                            <h5 class="mb-0 white-text text-uppercase font-thin">
                                                                                                + VITAMIN C<i class="fas fa-angle-down rotate-icon"></i>
                                                                                            </h5>
                                                                                        </a>
                                                                                    </div>
                                                                                    ...
                                                                                    data-parent="#accordionEx7">
                                                                                    <div class="card-body mb-1">
                                                                                        <p class="nutrition_detail">Vitamin C Is Essential In Not Only Keeping The
                                                                                            Immune System Healthy But Also Plays A Vital Role In Iron Absorption.</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <!-- Accordion card -->
                                                                                ...
                                                                                <div class="card">
                                                                                    ...
                                                                                    <div class="card-header rgba-stylish-strong z-depth-1 mb-1" role="tab" id="heading6">
                                                                                        ...
                                                                                        <h5 class="mb-0 white-text text-uppercase font-thin">
                                                                                            + Calcium<i class="fas fa-angle-down rotate-icon"></i>
                                                                                        </h5>
                                                                                    </a>
                                                                                </div>
                                                                                ...
                                                                                data-parent="#accordionEx7">
                                                                                <div class="card-body mb-1">
                                                                                    <p class="nutrition_detail">Calcium Helps Elongate And Strengthen Bones. Without
                                                                                        Proper Calcium, Consumption Growth Can Slow.</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <!-- Accordion card -->
                                                    ...
                                                    <!---- Micro Nutrient Section Ends -->

                                                    <!---- Suppliment Facts Section Start-->

                                                    <section class="supliment-facts">
                                                        <div class="container">
                                                            <div class="facts">
                                                        ...
                                                        <section class="reviews-section">
                                                            <div class="container">
                                                                <div class="top-heading">
                                                                    <h3>REAL STORIES THAT MATTER. NOT JUST REVIEWS</h3>
                                                                </div>
                                                                <div class="reviews">
                                                                    <div class="reviews-box">
                                                                        <div class="left-content-image left">
                                                                            <img src="/obvikids/images/other_images/asset_34.png" alt="" />
                                                                        </div>
                                                                        <div class="right-content-text">
                                                                            <span class="qoute_icon"></span>
                                                                            <span>ANNA</span>
                                                                            <h4>PICKY EATER APPROVED</h4>
                                                                            <p>I have tried so many kids protein for son who has ADHD and requires supplements to keep his
                                                                                weight up due to the appetite the medication can cause. (I mix it with whole fat milk) He
                                                                                would never drink any of the brands I purchased. After wasting so much money on other brands
                                                                                that tasted awful and he would not touch, I found obvi. It is amazing he asks for his shakes
                                                                                and looks forward to them daily and somethings twice a day. Thank you guys for making a
                                                                        ...
                                                                        <div class="reviews-box">
                                                                            <div class="right-content-text">
                                                                                <span class="qoute_icon"></span>
                                                                                <span>APRYL</span>
                                                                                <h4>ALMOST 3 POUNDS SO FAR</h4>
                                                                                <p>Hello Obvi! I’m new to the group and I just wanted to share a little story with you all. This
                                                                                    protein drink is working wonders for my son. We just recently got discharged from the
                                                                                    Hospital 2 weeks ago. As my son is in remission from Cancer (praise the lord) well while in
                                                                                ...
                                                                                <div class="left-content-image left">
                                                                                    <img src="/obvikids/images/other_images/asset_36.png" alt="" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <section class="rating-section">
                                                                    <div class="container p-0">
                                                                        <div class="top-heading">
                                                                            <h3>5 STAR RATINGS ARE NOT ENOUGH</h3>
                                                                            <span>WE WANT TO CHANGE LIVES</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="rating-content">
                                                                        <img src="/obvikids/images/section_banners/asset_62.png" alt="" />
                                                                    </div>
                                                                </section>

                                                                <!---- Rating Section Ends-->

                                                                <!---- Complete Shake Section Start-->

                                                                <section class="shake-section">
                                                                    <div class="container">
                                                                        <div class="shake-content">
                                                                            <div class="content-left-img">
                                                                                <img src="/obvikids/images/other_images/asset_38.png" alt="" />
                                                                            </div>
                                                                            <div class="content-right-text">
                                                                                <h3>MIX, SHAKE, BLEND OR BAKE</h3>
                                                                                <span class="sub-heading">HERE'S HOW TO MAKE A COMPLETE SHAKE</span>
                                                                                <p>SIMPLY ADD ONE SCOPE TO 8-10 OZ OF MILK OR WATER & REST EASY KNOWING YOUR CHILD'S NEEDS ARE 100%
                                                                                    COVERED WITHOUT ALL THE SUGAR!</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </section>

                                                                    <!---- Complete Shake Section Ends-->
                                                                    ...
                                                                    <section class="risk-section">
                                                                        <div class="container">
                                                                            <div class="top-icon">
                                                                                ...
                                                                                data-icon="lock-open" class="svg-inline--fa fa-lock-open fa-w-18" role="img" viewBox="0 0 576 512">
                                                                        ...
                                                                        <div class="risk-content-area">
                                                                            <h3>WE TOOK THE RISK OFF</h3>
                                                                            <p>WE ARE 100% CONFIDENT THAT YOUR PICKY EATER WILL START GETTING THE PROTEINS,VITAMINS AND MINERALS
                                                                                THEY NEED
                                                                                WHILE CRAVING THE DELICIOUS TASTE OF OBVI.</p>
                                                                            </div>
                                                                            <div class="risksub_content">IF THEY DON'T, THEN SEND IT BACK WITHIN 60 DAYS FOR YOUR MONEY BACK</div>
                                                                            {{-- <div class="risksub_lastcontent"></div> --}}
                                                                        </div>
                                                                    </section>

                                                                    <!---- Risk Section End-->

                                                                    <!----Watering Flavor Section Start-->
                                                                    <section class="mouth_watering_flavors">
                                                                        <div class="container">
                                                                            <div class="top-heading">
                                                                                <h3>MOUTH WATERING FLAVORS</h3>
                                                                                <span>OUR FLAVORS THAT TASTE AWESOME AND CONTAIN NO ADDITIONAL SUGARS</span>
                                                                            </div>
                                                                            <div class="flavors-box">
                                                                                <div class="flavor">
                                                                                    <a href="#">
                                                                                        <img src="/obvikids/images/flavour_section/asset_40.jpeg" alt="" />
                                                                                        <p>MARSHMALLOW CEREAL</p>
                                                                                    </a>
                                                                                </div>
                                                                                <div class="flavor">
                                                                                    <a href="#">
                                                                                        <img src="/obvikids/images/flavour_section/asset_41.png" alt="" />
                                                                                        <p>COCOA CEREAL</p>
                                                                                    </a>
                                                                                </div>
                                                                                <div class="flavor">
                                                                                    <a href="#">
                                                                                        <img src="/obvikids/images/flavour_section/asset_42.png" alt="" />
                                                                                        <p>FRUITY CEREAL</p>
                                                                                    </a>
                                                                                </div>
                                                                                <div class="flavor">
                                                                                    <a href="#">
                                                                                        <img src="/obvikids/images/flavour_section/asset_43.jpeg" alt="" />
                                                                                        <p>COOKIE CEREAL</p>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <section id="pkg_sec" class="package_section">
                                                                            <div class="container">
                                                                                ...
                                                                                <div class="packages_box">
                                                                                    ...
                                                                                    <div class="package">
                                                                                        <h4>OBVI KID'S COMPLETE PROTEIN</h4>
                                                                                        <span>2 BOTTLES (SAVE $15) + FREE RECIPE BOOK INCLUDED</span>
                                                                                        <img src="/obvikids/images/pricing_tables/asset_46.jpeg" alt="" />
                                                                            ...
                                                                            <div class="container">
                                                                                    ...
                                                                                    <div class="accordion md-accordion" id="accordionEx1" role="tablist" aria-multiselectable="true">
                                                                                        ...
                                                                                        <div class="card">
                                                                                            ...
                                                                                            <div class="card-header" role="tab" id="headingTwo1">
                                                                                                ...
                                                                                                <h5 class="mb-0">
                                                                                                    What are the age guidelines for Obvi Kids Complete Protein? <i
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            Obvi is a good source of protein, and 18 vitamins and minerals, for children between the
                                                                                            ages of 4 to 14 years
                                                                                            of age. If you’re thinking of starting your little one on Obvi Kids Complete Protein and
                                                                                ...
                                                                                <div class="card">
                                                                                    ...
                                                                                    <div class="card-header" role="tab" id="headingTwo2">
                                                                                        ...
                                                                                        <h5 class="mb-0">
                                                                                            Can a child younger than 4 years of age use Obvi Kids Complete Protein? <i
                                                                                            class="fas fa-plus rotate-icon"></i>
                                                                                        </h5>
                                                                                    </a>
                                                                                </div>
                                                                                ...
                                                                                data-parent="#accordionEx1">
                                                                                <div class="card-body">
                                                                                    Talk to a healthcare professional about use of this product if your child is younger
                                                                                    than 4 years of age. Obvi
                                                                        ...
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-header" role="tab" id="headingThree31">
                                                                                ...
                                                                                <h5 class="mb-0">
                                                                                    Can Obvi Kids Complete Protein be a sole source of nutrition for my child? <i
                                                                                    class="fas fa-plus rotate-icon"></i>
                                                                                </h5>
                                                                            </a>
                                                                        </div>
                                                                        ...
                                                                        data-parent="#accordionEx1">
                                                                        <div class="card-body">
                                                                            Obvi Kid’s Complete Protein are designed to provide a source of complete nutrition for
                                                                            children 4 to 14 years of
                                                                            age for supplemental use and designed for both short-term and long-term nutrition
                                                                            support. As with any nutrition
                                                                            product used as sole-source nutrition, a child using Obvi Kids Complete Protein in this
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-header" role="tab" id="headingThree32">
                                                                        ...
                                                                        <h5 class="mb-0">
                                                                            What is the recommended amount of Obvi Kid’s Complete Protein to use in a day? <i
                                                                            class="fas fa-plus rotate-icon"></i>
                                                                        </h5>
                                                                    </a>
                                                                </div>
                                                                ...
                                                                data-parent="#accordionEx1">
                                                                <div class="card-body">
                                                                    In general, there is not a limit on the amount of Kid’s Complete Protein that a child
                                                                    can safely consume, but we
                                                                    recommend a single scoop per day for best results. For an individual child, the amount
                                                                    of Obvi Kid’s Complete
                                                                    Protein that is needed—or is acceptable—on a daily basis should be discussed with the
                                                                    child's healthcare
                                                                    professional.
                                                                    Still searching? If your question isn't answered here, email us at <a
                                                                    href="mailto:hello@myobvi.com" class="linkout">hello@myobvi.com</a> with any
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-header" role="tab" id="headingThree33">
                                                                ...
                                                                <h5 class="mb-0">
                                                                    What is the best way to take Obvi Kid’s Complete Protein? <i
                                                                    class="fas fa-plus rotate-icon"></i>
                                                                </h5>
                                                            </a>
                                                        </div>
                                                        ...
                                                        data-parent="#accordionEx1">
                                                        <div class="card-body">
                                                            We recommend mixing, shaking, blending or baking our complete protein in with your
                                                            child’s choice of beverage.
                                                            Typically we see best results when mixed with cold milk or water! Obvi Kid’s Complete
                                                            Protein is also an
                                                            excellent source to bake with as an alliterative source of flavor and protein!
                                                            Still searching? If your question isn't answered here, email us at <a
                                                            href="mailto:hello@myobvi.com" class="linkout">hello@myobvi.com</a> with any
                                                            questions.
                                                        </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-header" role="tab" id="headingThree34">
                                                        ...
                                                        <h5 class="mb-0">
                                                            Is the Kids Complete Protein Gluten Free? <i class="fas fa-plus rotate-icon"></i>
                                                        </h5>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header" role="tab" id="headingThree35">
                                                ...
                                                <h5 class="mb-0">
                                                    Does Obvi Kids Complete protein contain peanuts or tree nuts? <i
                                                    class="fas fa-plus rotate-icon"></i>
                                                </h5>
                                            </a>
                                        </div>
                                        ...
                                        data-parent="#accordionEx1">
                                        <div class="card-body">
                                            No, the protein does not contain peanuts or tree nuts!
                                            Still searching? If your question isn't answered here, email us at <a
                                            href="mailto:hello@myobvi.com" class="linkout">hello@myobvi.com</a> with any
                                            questions.
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingThree36">
                                        ...
                                        <h5 class="mb-0">
                                            Is the Kids Complete Protein Non-GMO? <i class="fas fa-plus rotate-icon"></i>
                                        </h5>
                                    </a>
                                </div>
                                ...
                                data-parent="#accordionEx1">
                                <div class="card-body">
                                    Our Kids Complete Protein is made from Non-GMO Protein Sources!
                                    Still searching? If your question isn't answered here, email us at <a
                                    href="mailto:hello@myobvi.com" class="linkout">hello@myobvi.com</a> with any
                                    questions.
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingThree37">
                                ...
                                <h5 class="mb-0">
                                    Is the Kids Complete Protein created at a safe facility? <i
                                    class="fas fa-plus rotate-icon"></i>
                                </h5>
                            </a>
                        </div>
                        ...
                        data-parent="#accordionEx1">
                        <div class="card-body">
                            Yes. All of our products are made at a FDA approved facility that follows all cGMP
                ...
                <div class="card">
                    ...
                    <div class="card-header" role="tab" id="headingThree38">
                        ...
                        <h5 class="mb-0">
                            What is the shelf life of Obvi Products? <i class="fas fa-plus rotate-icon"></i>
                        </h5>
                    </a>
                </div>
                ...
                data-parent="#accordionEx1">
                <div class="card-body">
                    Our powder products are guaranteed fresh 2 years from the date of manufacture. The
                    expiration date is located on
    ...
    <div class="container">
        <div class="footer-content">
            <div class="footer-logo">
                <a href="#"><img src="/obvikids/images/logo.png" alt="" /></a>
            </div>
...
<!-- jQuery -->
<script type="text/javascript" src="/obvikids/js/jquery.min.js"></script>
<script type="text/javascript" src="/obvikids/js/bootstrap.min.js"></script>
<!-- custom JavaScript -->
<script type="text/javascript" src="/obvikids/js/custom.js"></script>
<!-- MDB core JavaScript -->
